   ...
   <asp:Table ID="Table1" runat="server" HorizontalAlign="Right">
        ...
        <asp:Table ID="Table4" runat="server" HorizontalAlign="Center" Width="100%" Height="23px">
            <asp:TableRow runat="server" HorizontalAlign="Center">
                <asp:TableCell runat="server"><asp:Label ID="Label4" runat="server" Text="異常一覽" Font-Size="30px"></asp:Label></asp:TableCell>
            </asp:TableRow>
        </asp:Table>             
        <asp:Panel ID="Panel1" runat="server" Height="307px" HorizontalAlign="Center" Width="100%">
           ...
           <asp:GridView ID="GridView1" runat="server" Width="95%" CellPadding="4" ForeColor="Black" GridLines="Horizontal"  AllowPaging ="True" OnPageIndexChanging ="GridView1_PageIndexChanging"
    ...
    <asp:TemplateField HeaderText="處理狀態" >
                    <ItemTemplate >
                        <asp:Label ID ="處理狀態" runat ="server" Text='<%#Eval("status")%>'></asp:Label>
                    </ItemTemplate>
