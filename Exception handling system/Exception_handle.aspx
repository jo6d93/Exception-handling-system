<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Exception_handle.aspx.vb" Inherits="Exception_handling_system.Exception_handle" %>
...
<asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/Image/4.bmp" OnClick="ImageButton4_Click"  Height="45px" Width="130px"/>   
   ...
   <asp:Table ID="Table4" runat="server" HorizontalAlign="Right">
        ...
        <asp:Table ID="Table5" runat="server" HorizontalAlign="Center" Width="100%" Height="23px">
            <asp:TableRow runat="server" HorizontalAlign="Center">
                <asp:TableCell runat="server"><asp:Label ID="Label4" runat="server" Text="異常原因填寫" Font-Size="30px"></asp:Label></asp:TableCell>
            </asp:TableRow>
        </asp:Table>
              
           <asp:GridView ID="GridView1" runat="server" Width="80%" CellPadding="4" ForeColor="Black" GridLines="Horizontal"  AllowPaging ="True"
            HorizontalAlign="Center" AutoGenerateColumns="False"    BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" >
 ...
 <FooterStyle BackColor="#CCCC99" ForeColor="Black" />
        ...
        <asp:Panel ID="Panel4" runat="server" HorizontalAlign="Center">
                        <asp:Label ID="Label10" runat="server" Text="請先選擇要查詢的資料" Font-Size="X-Large" ForeColor="Red" ></asp:Label>
        </asp:Panel>
        ...
        <asp:Panel ID="Panel1" runat="server">
            ...
            <asp:Table ID="Table1" runat="server" Height="200px"  BorderColor="#CCCCCC" HorizontalAlign="Center" BorderStyle="Solid" BorderWidth="2px" Width="100%"  CellSpacing ="0">
                <asp:TableRow runat="server" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="2" HorizontalAlign="Center" VerticalAlign="Middle">
                    <asp:TableCell runat="server" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="2" Width="50" VerticalAlign="Middle" HorizontalAlign="Center">
                        <asp:Button ID="Button4" runat="server" Text="駁回" OnClick ="Button4_Click"   Visible ="false" />
                        <asp:Button ID="Button11" runat="server" Text="取消駁回"  OnClick ="Button11_Click" Visible ="false" />                        
<asp:Label ID ="Label7" runat="server" Text="已通知重寫"  Width="100px" Visible ="false" ></asp:Label>
                    ...
                    <asp:TableCell runat="server" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="2" Width="110" HorizontalAlign="Center" VerticalAlign="Middle">
                        <asp:Label ID="Label2" runat="server" Text="異常調查原因" Font-Size="Large" Width="110px"></asp:Label>                 
                     ...
                     <asp:TableCell runat="server" Width="130px" HorizontalAlign="Center" VerticalAlign="Middle">

                         <asp:Label ID="Label6" runat="server" Text="責任部屬"></asp:Label>
<br/>
                         <asp:DropDownList ID="DropDownList1" runat="server" Width="80px" Font-Size="Medium" Visible ="false" ></asp:DropDownList>

<br/>   
                         <asp:Label ID="Label11" runat="server" Text="" Visible ="false" ></asp:Label>              

               <br/>          
<asp:Label ID="Label9" runat="server" Text="請選擇責任部屬" ForeColor="Red"   Visible ="false"  ></asp:Label>                   
</asp:TableCell>
                    <asp:TableCell runat="server" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="2" Width="50" HorizontalAlign="Center" VerticalAlign="Middle">
                         <asp:Button ID="Button1" runat="server" Text="修改"  OnClick ="Button1_Click"   Visible ="false" />
                        <asp:Button ID="Button8" runat="server" Text="新增"  OnClick ="Button8_Click"  Visible ="false"   />                   
...
<ItemStyle Width ="200px" HorizontalAlign="Center"/>
                ...
                <asp:TableRow runat="server" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1" HorizontalAlign="Center" VerticalAlign="Middle">
                    <asp:TableCell runat="server" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="2" Width="100" VerticalAlign="Middle">
                        <asp:Button ID="Button5" runat="server" Text="駁回" OnClick ="Button5_Click"    Visible ="false"  />
                        <asp:Button ID="Button10" runat="server" Text="取消駁回" OnClick ="Button10_Click"  Visible ="false"  />
                        <asp:Label ID="Label8" runat="server" Text="已通知重寫"  Width="100px" Visible ="false" ></asp:Label>

</asp:TableCell>
                    <asp:TableCell runat="server" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="2" Width="110" HorizontalAlign="Center" VerticalAlign="Middle">
                        <asp:Label ID="Label5" runat="server" Text="再發防止" Font-Size="Larger"></asp:Label>                   
                    ...
                    <asp:TableCell runat="server" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="2" HorizontalAlign="Center" VerticalAlign="Middle">
                      ...
                      <asp:TableCell runat="server" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="2" Width="50" HorizontalAlign="Center" VerticalAlign="Middle">
                         <asp:Button ID="Button2" runat="server" Text="修改" OnClick ="Button2_Click"  Visible ="false"  />
                           <asp:Button ID="Button9" runat="server" Text="新增"   OnClick ="Button9_Click"  Visible ="false"    />
</asp:TableCell>
                     <asp:TableCell runat="server" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="2" VerticalAlign="Middle" HorizontalAlign="Center">

                         <asp:Button ID="Button3" runat="server" Text="送出簽核"  OnClick ="Button3_Click"   Visible ="false" />
...
<ItemStyle Width ="200px" HorizontalAlign="Center"/>
        ...
        <asp:Panel ID="Panel5" runat="server" HorizontalAlign="Center" Width="100%" Visible ="false"  >
            ...
            <asp:Table ID="Table6" runat="server" Height="100px" HorizontalAlign="Left" Width="350px"  >
                ...
                <asp:TableRow runat="server">
                    <asp:TableCell runat="server" ColumnSpan="3"> <asp:Label ID="Label12" runat="server" Text="異常調查原因駁回原因:"></asp:Label>
</asp:TableCell>
        ...
        <asp:Panel ID="Panel6" runat="server" HorizontalAlign="Center" Width="100%"   Visible ="false" >
            <asp:Table ID="Table7" runat="server" Height="100px" HorizontalAlign="Left" Width="350px">
                <asp:TableRow runat="server">
                </asp:TableRow>
                <asp:TableRow runat="server">
                    <asp:TableCell runat="server" ColumnSpan="3"><asp:Label ID="Label14" runat="server" Text="再發防止駁回原因:"></asp:Label>
</asp:TableCell>
        ...
        <asp:Label ID="Label15" runat="server" Text="" Font-Size="30px" Visible ="true" ></asp:Label>
</asp:Panel>
    </form>
</body></html>
